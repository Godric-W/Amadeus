...
func TestModelInfoNormalizedDefaultsAndOnlyTightensAutoCompactLimit(t *testing.T) {
	...
	if defaulted.AutoCompactTokenLimit != 900 || defaulted.ToolOutputTokenLimit != 10_000 || !defaulted.SupportsInput(InputModalityText) || defaulted.SupportsInput(InputModalityImage) {
