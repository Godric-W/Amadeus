...
var sourceManifest = []SourceAsset{
	...
	{ID: "multi_agent.role.subagent", Family: SourceAmadeus, Path: "internal/prompt/builtin/templates/agent/subagent.md", AdaptedSHA256: "3fe8bc0df5be5e3c0035e5a4fb00e2be581bcf9f8f326689355728416c93184d", AdaptationRule: "Amadeus owns the basic read-only explorer role and budget-finalization text; Codex defines its ModelMessages.MultiAgent.Role.Subagent ownership and separate developer-fragment lifecycle."},
