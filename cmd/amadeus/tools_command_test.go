...
func TestToolsListShowsTargetExposureAndMigrationMetadata(t *testing.T) {
	...
	wantNames := []string{"read", "edit", "write", "glob", "grep", "execute_command", "update_plan", "request_user_input", "write_stdin", "view_image", "read_skill", "web_search", "web_fetch", "mcp_list_tools", "mcp_call", "mcp_list_resources", "mcp_read_resource"}
