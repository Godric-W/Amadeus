...
`)
	...
	command := newRootCommandWithOptions(&configFlags{}, RootOptions{
		Environment: bootstrap.Environment{AmadeusRoot: amadeusRoot, LookupEnv: emptyEnvLookup},
		Bootstrap:   bootstrap.Dependencies{WebFetcher: fetcher, WebSearch: search},
	})
