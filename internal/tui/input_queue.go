...
func (queue *NextTurnQueue) Begin(threadID protocol.ThreadID, generation uint64, mode protocol.ModeKind) (QueuedUserMessage, bool, error) {
...
func (model appModel) queueComposerInput() (tea.Model, tea.Cmd) {
...
func (model appModel) hasQueueableDraft() bool {
...
func (model appModel) enqueueInputResult(input InputResult) (tea.Model, tea.Cmd) {
...
func (model *appModel) maybeSubmitNextQueuedInput() tea.Cmd {
	if model == nil {
		return nil
	}
...
func (model *appModel) restoreQueuedInputsToComposer() {
	if model == nil {
		return
	}
...
func (model *appModel) restoreRejectedQueuedInput(submission UserMessageSubmission) bool {
...
func (model appModel) queuedInputPreview() string {
