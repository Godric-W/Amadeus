...
func (model *appModel) resetStatusLineWorkspace() tea.Cmd {
...
func (model appModel) statusLineBranchLookupCommand() tea.Cmd {
...
func (model *appModel) applyStatusLineBranchUpdate(message statusLineBranchUpdatedMsg) {
